...
const App = () => {
	...
	const refreshValues = [1, 2, 5, 10, 15, 20, 30, 45, 60, 90, 120];
	const defaultIndex = refreshValues.indexOf(15); // Find the index for 15
	...
	return (
		<div style={{ textAlign: "center" }}>
			...
			<button
				onClick={handleSave}
				style={{ height: "18.67px", lineHeight: "0px", marginTop: "15px", marginBottom: "15px" }}
			>
				Update Display
			</button>
			...
			<div>
				...
				<div style={{ marginTop: '10px' }}>Check your E-ink display manual for refresh limits.</div>
			</div>
